...
<div style="max-width:580px;margin:40px auto;background:#fff;border:1px solid #DDE5DD;border-radius:20px;overflow:hidden">
  <div style="background:#1B4332;padding:26px 30px">
  ...
  <div style="padding:26px 30px">
    ...
    <p style="font-size:1.05rem;font-weight:700;color:#1F2937;margin-bottom:18px">{operation}</p>
    ...
    <a href="{report_url}" style="display:inline-block;background:#2E7D32;color:#fff;text-decoration:none;padding:13px 26px;border-radius:14px;font-weight:700;font-size:.88rem;box-shadow:0 4px 14px rgba(46,125,50,.25)">View Full Report &rarr;</a>
...
<div style="max-width:560px;margin:40px auto;background:#fff;border:1px solid #DDE5DD;border-radius:20px;overflow:hidden">
  ...
  <div style="padding:26px 30px">
    ...
    <a href="{APP_BASE_URL}" style="display:inline-block;background:#2E7D32;color:#fff;text-decoration:none;padding:13px 26px;border-radius:14px;font-weight:700;font-size:.88rem;box-shadow:0 4px 14px rgba(46,125,50,.25)">Run Your First Check &rarr;</a>
    <p style="font-size:.78rem;color:#6B7280;margin-top:22px;line-height:1.5">
      Questions? Reply to <a href="mailto:support@organicwebchecker.com" style="color:#2E7D32">support@organicwebchecker.com</a> — we&rsquo;re here to help.
    </p>
...
GLOBAL_CSS = """
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  header {
    ...
    box-shadow: 0 2px 16px rgba(27,67,50,.18);
    padding: 14px 32px;
  ...
  .header-cta-btn:hover { background: #1B4332; box-shadow: 0 6px 20px rgba(46,125,50,.4); }
  ...
  button[type=submit]:hover, .btn-primary:hover {
    background: #1B4332;
    box-shadow: 0 10px 26px rgba(46,125,50,.26);
  }
  ...
  .checker-loader {
    ...
    background: var(--lavender); border: 1px solid rgba(46,125,50,.2);
  }
  .cb-p {
  ...
  .view-btn {
    ...
    border: 1.5px solid rgba(46,125,50,.25); border-radius: 8px;
    color: var(--primary); background: var(--lavender);
    cursor: pointer; flex-shrink: 0; text-decoration: none;
    transition: background .15s; font-weight: 600;
  }
  .view-btn:hover { background: rgba(46,125,50,.14); }
  ...
  .dl-btn.md  { color: var(--primary); border-color: rgba(46,125,50,.3); background: rgba(46,125,50,.06); }
  .dl-btn.md:hover  { background: rgba(46,125,50,.14); }
  ...
  .stat.verified .num { color: #2E7D32; }
  ...
  .section-label.cyan   { color: #2E7D32; }
  ...
  .green  .badge { background: #E8F5E9; border-color: #A5D6A7; color: #2E7D32; }
  .cyan   .badge { background: #E8F5E9; border-color: #A5D6A7; color: #2E7D32; }
  ...
  .scrollable-list::-webkit-scrollbar-thumb { background: #A5D6A7; border-radius: 2px; }

  .clean     { color: #2E7D32; font-weight: 700; padding: 14px 0; }
  ...
  .pricing-card.featured {
    ...
    box-shadow: 0 8px 30px rgba(46,125,50,.12);
  }
  ...
  .pricing-disc      { font-size: .7rem; font-weight: 700; color: #2E7D32; margin-bottom: 14px; }
  ...
  .pricing-cta:hover { background: #1B4332; box-shadow: 0 10px 26px rgba(46,125,50,.26); }
  .pricing-cta.contact {
    background: var(--lavender); color: var(--primary);
    border: 1.5px solid rgba(46,125,50,.25); box-shadow: none;
  }
  .pricing-cta.contact:hover { background: #E8F5E9; }
  .coming-soon-note {
  ...
  .history-item:hover { border-color: rgba(46,125,50,.25); box-shadow: 0 8px 24px rgba(31,41,55,.08); }
  ...
  .settings-note {
    ...
    background: var(--lavender); border: 1px dashed rgba(46,125,50,.2);
  ...
  .sc-box.sc-fines  .sc-num { color: #2E7D32; }
  ...
  .ps-active  .ps-num { background: var(--lavender); color: var(--primary); border: 1px solid rgba(46,125,50,.3); animation: pulse 1.4s ease-in-out infinite; }
  .ps-done    .ps-num { background: #E8F5E9; color: #2E7D32; border: 1px solid #A5D6A7; }
  ...
  .ps-active  .ps-fill {
    width: 65%;
    background: linear-gradient(90deg, #1B4332 0%, #2E7D32 50%, #1B4332 100%);
    background-size: 200% 100%;
    animation: shimmer 1.6s ease-in-out infinite;
  }
  @keyframes shimmer { 0%,100%{background-position:0% 50%} 50%{background-position:100% 50%} }
  .ps-done .ps-fill { width: 100%; background: #2E7D32; }
  ...
  .certbridge-badge {
    ...
    background: #E8F5E9; border: 1px solid #A5D6A7; color: var(--primary);
  }
  .about-bottom-line {
  ...
  .cta-btn:hover { background: #1B4332; box-shadow: 0 10px 26px rgba(46,125,50,.26); }

  /* ── Site footer ─────────────────────────────────────────────────────── */
  .site-footer { background: #1B4332; color: rgba(255,255,255,.7); padding: 40px 0 0; }
  .site-footer-inner {
  ...
  /* ── Auth modal ──────────────────────────────────────────────────────── */
  .modal-overlay {
    position: fixed; inset: 0; background: rgba(27,67,50,.45); z-index: 9000;
    display: flex; align-items: center; justify-content: center;
  ...
  .auth-msg.success { background: #E8F5E9; border: 1px solid #A5D6A7; color: #2E7D32; }
  .nav-user-email {
    font-size: .82rem; font-weight: 600; color: #81C784;
    padding: 5px 10px; background: rgba(255,255,255,.1); border-radius: 8px;
  }
  .nav-signout {
  ...
  .gate-btn-primary {
    ...
    transition: background .15s; box-shadow: 0 8px 20px rgba(46,125,50,.18);
  }
  .gate-btn-primary:hover { background: #1B4332; }
  .gate-btn-secondary {
  ...
  .gate-btn-secondary:hover { background: #F3FAF3; }
  .gate-meta-block {
  ...
  .btn-glass:hover {
    background: #1B4332;
    box-shadow: 0 10px 26px rgba(46,125,50,0.26);
  ...
  .next-avail-label { font-size: .75rem; font-weight: 700; color: #1B4332; text-transform: uppercase; letter-spacing: .06em; }
  .next-avail-time  { font-size: 1rem; font-weight: 800; color: #1B4332; margin-top: 2px; }
  ...
  .selected-slot-display {
    background: var(--lavender); border: 1.5px solid rgba(46,125,50,.3);
  ...
  .sched-view-btn {
    font-size: .7rem; padding: 4px 10px; border-radius: 8px;
    border: 1.5px solid rgba(46,125,50,.25); color: var(--primary);
  ...
  <div class="header-right">
    <div id="navUserArea">
      {% if user_email %}
        ...
        {% if user_is_admin %}<span style="font-size:.75rem;color:rgba(255,255,255,.55)">Admin</span>{% else %}<span style="font-size:.75rem;color:rgba(255,255,255,.55)">{{ user_credits }} credit{{ 's' if user_credits != 1 else '' }}</span>{% endif %}
...
function updateAuthUI(email,credits){
  ...
  if(email){
    ...
    el.innerHTML='<span class="nav-user-email">'+email+'</span>&nbsp;<span style="font-size:.75rem;color:rgba(255,255,255,.55)">'+credTxt+'</span>&nbsp;<button class="nav-signout" onclick="doLogout()">Sign Out</button>';
  }else{
    el.innerHTML='';
  }
}
...
{% else %}
  ...
  <div class="meta-grid">
    ...
    <div class="meta-item"><label>Website</label><span><a href="{{ report.website_url }}" target="_blank" rel="noopener" style="color:var(--primary);text-decoration:none;border-bottom:1px solid rgba(46,125,50,.25)">{{ report.website_url }}</a></span></div>
  </div>

  {# ── Handling scope notice ─────────────────────────────────────── #}
  {% if 'HANDLING' in (report.get('scope') or []) %}
  <div style="margin-bottom:18px;padding:12px 16px;border-radius:14px;background:#E8F5E9;border:1px solid rgba(46,125,50,.2);font-size:.78rem;line-height:1.6;color:var(--text)">
    <strong style="color:var(--primary)">&#9432; Handling Operation Scope Notice</strong>
    {% if report.get('business_type') %}<span style="margin-left:6px;font-size:.65rem;padding:1px 7px;border-radius:20px;font-weight:600;background:#C8E6C9;color:#1B4332;border:1px solid #A5D6A7">{{ report.business_type }}</span>{% endif %}<br>
...
<head>
  ...
  .hero-eyebrow-dot { width: 6px; height: 6px; border-radius: 50%; background: #2E7D32; flex-shrink: 0; }
  .hero-h1 {
  ...
  .hero-btn-primary:hover { background: #1B4332; box-shadow: 0 10px 26px rgba(46,125,50,.26); transform: translateY(-1px); }
  .hero-btn-secondary {
    background: #fff; color: #2E7D32;
    border: 1.5px solid #2E7D32; border-radius: 14px; padding: 13px 26px;
  ...
  .hero-btn-secondary:hover { background: #F3FAF3; transform: translateY(-1px); }
  ...
  .hero-trust-check { color: #2E7D32; font-weight: 700; }
  ...
  .hero-card-dot { width: 8px; height: 8px; border-radius: 50%; background: #2E7D32; }
  .mock-row {
    display: flex; align-items: center; justify-content: space-between;
  ...
  .chip-neutral { background: var(--lavender); color: var(--primary); border-color: rgba(46,125,50,.2); }
  ...
  .feature-card:hover { transform: translateY(-3px); box-shadow: 0 14px 36px rgba(31,41,55,.10); border-color: rgba(46,125,50,.2); }
  .feature-icon {
...
def pricing_page_html():
    ...
    custom = """
        <div class="pricing-card" style="border-color:rgba(46,125,50,.3);background:linear-gradient(135deg,rgba(46,125,50,.04) 0%,transparent 100%)">
          <div class="pricing-icon-row">
            <img src="/static/icon.png" class="pricing-icon" alt="">
            <div class="pricing-mult" style="color:#1B4332">CA</div>
          </div>
          <div class="pricing-tier-name">Certifying Agents</div>
          <div style="display:inline-block;background:rgba(46,125,50,.1);border:1px solid rgba(46,125,50,.3);border-radius:20px;padding:5px 11px;font-size:.78rem;font-weight:700;color:#1B4332;margin-bottom:10px">Exclusive discount</div>
          <div class="pricing-price" style="font-size:1.7rem;color:#1B4332">50% off</div>
          <div class="pricing-per">any tier &mdash; verified certifiers only</div>
          <div class="pricing-disc" style="color:#2E7D32">Promo code sent after verification</div>
          ...
          <button onclick="openCertModal()" class="pricing-cta" style="background:transparent;border:2px solid #2E7D32;color:#2E7D32">Request Certifier Access &rarr;</button>
        </div>"""
  ...
  <div id="acctLoggedIn" style="display:none">
    ...
    <div class="card" style="max-width:540px;margin:0 auto 22px">
      ...
      <div style="display:flex;gap:12px;align-items:center;padding:18px;background:var(--lavender);border-radius:16px;margin-bottom:20px">
        ...
        <a href="/pricing" style="margin-left:auto;font-size:.85rem;font-weight:600;color:#2E7D32;text-decoration:none;background:#fff;padding:9px 18px;border-radius:12px;border:1.5px solid #2E7D32">Buy more &rarr;</a>
      </div>
    ...
    <div class="card" style="max-width:540px;margin:0 auto">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:18px">
        ...
        <button id="apiKeyCreateBtn" onclick="apiKeyCreate()" style="font-size:.8rem;font-weight:700;padding:8px 18px;background:#2E7D32;color:#fff;border:none;border-radius:12px;cursor:pointer;box-shadow:0 4px 12px rgba(46,125,50,.2)">+ New Key</button>
      </div>
      <div id="apiKeyNewBox" style="display:none;padding:14px;background:#E8F5E9;border:1px solid #A5D6A7;border-radius:14px;margin-bottom:16px;font-size:.82rem">
        <strong style="color:#2E7D32">Key created — copy it now, it won&rsquo;t be shown again:</strong><br>
        <div style="display:flex;gap:8px;margin-top:8px;align-items:center">
          <code id="apiKeyNewValue" style="background:#C8E6C9;padding:6px 10px;border-radius:8px;font-size:.78rem;word-break:break-all;flex:1"></code>
          <button onclick="navigator.clipboard.writeText(document.getElementById('apiKeyNewValue').textContent);this.textContent='Copied!'" style="font-size:.72rem;padding:5px 10px;background:#2E7D32;color:#fff;border:none;border-radius:8px;cursor:pointer;white-space:nowrap">Copy</button>
        </div>
      ...
      <div id="apiKeyNameBox" style="display:none;margin-bottom:14px">
        ...
        <div style="display:flex;gap:8px">
          <button onclick="apiKeyConfirmCreate()" style="font-size:.8rem;font-weight:700;padding:8px 18px;background:#2E7D32;color:#fff;border:none;border-radius:12px;cursor:pointer">Create</button>
...
<div class="card">
  ...
  <div class="setting-row">
    ...
    <button style="font-size:.76rem;padding:6px 14px;background:var(--lavender);border:1.5px solid rgba(46,125,50,.25);border-radius:10px;color:var(--primary);cursor:pointer;margin-left:16px;font-weight:600" onclick="alert('API access coming soon with account launch.')">Generate Key</button>
  </div>
  <div class="setting-row">
    <div class="setting-info">
...
<h2 style="color:#1B4332;font-size:1.2rem;margin-bottom:8px">Password Reset</h2>
<p style="color:#6B7280;font-size:.9rem;line-height:1.6;margin-bottom:24px">
  You requested a password reset for your Organic Web Checker account.
  Click the button below — the link expires in 1 hour.
</p>
<a href="{reset_url}" style="display:inline-block;background:#2E7D32;color:#fff;text-decoration:none;padding:13px 28px;border-radius:14px;font-weight:700;font-size:.9rem;box-shadow:0 4px 14px rgba(46,125,50,.25)">Reset Password</a>
...
def history():
    ...
    def _row(j):
        ...
        status_color = '#2E7D32' if j['status'] == 'done' else 'var(--red)'
        ...
        md_link  = f'<a class="view-btn" href="/job/{j["id"]}/download/md" style="color:var(--primary);border-color:rgba(46,125,50,.25)">&#8595; .md</a>' if not j.get('from_db') else ''
...
AGENTS_CSS = """
  .api-endpoint {
    ...
    padding: 12px 0; border-bottom: 1px solid rgba(46,125,50,.08);
    font-size: .82rem;
  }
  ...
  .api-method.get  { background: rgba(46,125,50,.08);  color: var(--primary);  border: 1px solid rgba(46,125,50,.2); }
  .api-path { font-family: monospace; font-size: .82rem; color: var(--primary); padding-top: 2px; }
  .api-desc { color: var(--muted); line-height: 1.5; }
  .api-desc code { background: rgba(46,125,50,.08); color: var(--primary); padding: 1px 5px; border-radius: 4px; font-size: .78rem; }
"""
